...
public class BackWorkerLog implements Runnable {


    private String login;
    private String password;
    private Connecter_Activity activity;


    public BackWorkerLog( Connecter_Activity activity, String login, String password)
    {
